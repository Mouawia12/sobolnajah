            ...
            <div class="col-lg-3 col-md-4 col-12">
                <div class="box position-sticky t-100">
                    <div class="box-body text-center">
                        ...
                        <div class="badge badge-info-light fs-16">/////</div>
                                ...
                                <ul class="list-unstyled clearfix">
                                    <li class="w-md-p50 float-start pb-10">
                                        <a href="#" class="text-dark d-flex justify-content-between pe-50">
                                            ...
                                            <span class="text-muted">{{ $ParentInfo->prenomwali }}&nbsp;{{ $ParentInfo->nomwali }}</span>
                                        </a>
                                    </li>
                                    <li class="w-md-p50 float-start pb-10">
                                        <a href="#" class="text-dark d-flex justify-content-between">
                                            <span class="fw-500">{{ trans('student.adresse') }}</span>
                                            <span class="text-muted">{{ $ParentInfo->wilayawali }} &nbsp;, {{ $ParentInfo->dayrawali }}&nbsp;, {{ $ParentInfo->baladiawali }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="w-md-p50 float-start pb-10">
                                        <a href="#" class="text-dark d-flex justify-content-between pe-50">
                                            ...
                                            <span class="text-muted">{{ $ParentInfo->user->email }}</span>
                                        </a>
                                    </li>

                                    <li class="w-md-p50 float-start pb-5">
                                        <a href="#" class="text-dark d-flex justify-content-between">
                                            <span class="fw-500">{{ trans('inscription.datenaissance') }}</span>
                                            <span class="text-muted">{{ $ParentInfo->relationetudiant}} </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="w-md-p50 float-start pb-10">
                                        <a href="#" class="text-dark d-flex justify-content-between">
                                            ...
                                            <span class="text-muted">0{{ $ParentInfo->numtelephonewali }}</span>
                                        </a>
                                    </li>
                                </ul>
                                <hr>
                             ...
                             <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">									
                                <div class="row">
                                    <div class="col-12">
                                        <form class="form">
                                            <div>
                                                <h4 class="box-title text-info"><i class="ti-user me-15"></i>{{ trans('student.chapter1') }}</h4>
                                                <div class="bb-1 clearFix">
                                                    <div class="text-center pb-15">
                                                        <button class="btn btn-success" type="button"> <span><i class="fa fa-print"></i> Download</span> </button>
                                                        <button id="print2" class="btn btn-warning" type="button"> <span><i class="mdi mdi-eye-outline"></i> View</span> </button>
                                                    </div>	
                                                  </div>
                                                <hr class="my-15">
                                                <h4 class="box-title text-info mt-30"><i class="ti-envelope me-15"></i>{{ trans('student.chapter2') }}</h4>
                                                <div class="bb-1 clearFix">
                                                    <div class="text-center pb-15">
                                                        <button class="btn btn-success" type="button"> <span><i class="fa fa-print"></i> Download</span> </button>
                                                        <button id="print2" class="btn btn-warning" type="button"> <span><i class="mdi mdi-eye-outline"></i> View</span> </button>
                                                ...
                                                <h4 class="box-title text-info mt-30"><i class="ti-share me-15"></i>{{ trans('student.chapter3') }}</h4>
                                                <div class="bb-1 clearFix">
                                                    <div class="text-center pb-15">
                                                        <button class="btn btn-success" type="button"> <span><i class="fa fa-print"></i> Download</span> </button>
                                                        <button id="print2" class="btn btn-warning" type="button"> <span><i class="mdi mdi-eye-outline"></i> View</span> </button>
