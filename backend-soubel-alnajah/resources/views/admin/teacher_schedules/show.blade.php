...
@section('titlea', trans('teacher_schedule.show'))
    ...
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border d-flex justify-content-between">
                <h4 class="box-title">{{ $schedule->title ?: trans('teacher_schedule.title') }}</h4>
                <div>
            ...
            <div class="box-body">
                ...
                <p><strong>{{ trans('teacher_schedule.branch_name') }}:</strong> {{ $schedule->branch_name ?: '—' }}</p>
