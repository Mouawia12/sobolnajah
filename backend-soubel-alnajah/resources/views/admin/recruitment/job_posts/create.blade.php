...
@section('titlea', trans('recruitment.breadcrumbs.add_job_post'))
            ...
            <div class="box-body">
                <form method="POST" action="{{ route('JobPosts.store') }}" class="admin-form-panel">
                    ...
                    @if($canPickSchool)
                        <div class="mb-3">
                            ...
                            <select name="school_id" class="form-select" required>
                                <option value="">{{ trans('recruitment.admin.choose_school') }}</option>
                    ...
                    <div class="admin-form-actions">
                        <button class="btn btn-primary">{{ trans('recruitment.admin.save') }}</button>
                        <a href="{{ route('JobPosts.index') }}" class="btn btn-outline-secondary">{{ trans('recruitment.admin.cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
