                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-warning">
                                <h5 class="modal-title">تسجيل الغياب — <span id="attendanceStudentName"></span></h5>
                            ...
                            <div class="modal-body">
                                ...
                                <h6 class="mt-3">الفترة الصباحية</h6>
                                ...
                                <h6 class="mt-3">الفترة المسائية</h6>
                            ...
                            <div class="modal-footer text-center">
                                <small class="text-muted me-auto">اضغط على أي خانة لتبديل حالة الحضور/الغياب</small><br>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.open-absence-modal').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                e.stopPropagation(); // منع أي Submit من الـ Theme
                ...
                // إعادة تعيين الشيكبوكس افتراضيًا على حاضر
                document.querySelectorAll('.attendance-hour').forEach(chk => chk.checked =
                    true);

                // جلب حالة الغياب لليوم
                    ...
                    .then(data => {
                        document.querySelectorAll('.attendance-hour').forEach(chk => {
                            ...
                            if (data.hasOwnProperty(key)) {
                                chk.checked = !!data[key];
                            }
                        });
                    })
                    .catch(() => {
                        // لا نفعل شيء إذا لم نجد بيانات
                    })
                    .finally(() => {
        ...
        document.querySelectorAll('.attendance-hour').forEach(chk => {
            chk.addEventListener('change', function() {
                ...
                fetch("{{ route('absence.update') }}", {
                    ...
                    .then(json => {
                        console.log('غياب الطالب تم حفظه ✅', json);
                    })
                    .catch(err => {
                        this.checked = !this.checked; // إعادة الحالة إذا فشل
                        alert('تعذر حفظ التغيير ❌ تحقق من الـ route أو السيرفر');
                        console.error(err);
                    });
            });
        });
