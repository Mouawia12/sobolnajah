			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li class="treeview">
					<a href="#">
					  ...
					  <span>{{ trans('main_sidebar.ecoles') }}</span>
				  ...
				  <li class="treeview">
					<a href="#">
					  <i class="mdi mdi-school me-15"><span class="path1"></span><span class="path2"></span></i>
					  <span>{{ trans('main_sidebar.classe') }}</span>
					  <span class="pull-right-container">
						<i class="fa fa-angle-right pull-right"></i>
					  </span>
					</a>
				  ...
				  <li class="treeview">
					<a href="#">
					  <i class="mdi mdi-school me-15"><span class="path1"></span><span class="path2"></span></i>
					  <span>{{ trans('main_sidebar.classerooms') }}</span>
					  <span class="pull-right-container">
						<i class="fa fa-angle-right pull-right"></i>
					  </span>
					</a>
				  ...
				  <li class="treeview">
					<a href="#">
					  <i class="mdi mdi-school me-15"><span class="path1"></span><span class="path2"></span></i>
					  <span>{{ trans('main_sidebar.sections') }}</span>
					  <span class="pull-right-container">
						<i class="fa fa-angle-right pull-right"></i>
					  </span>
					</a>
				...
				<li class="header">{{ trans('inscription.student') }} </li>
				<li class="treeview">
				  <a href="#">
				...
				<li class="header">{{ trans('main_header.agendascolaire') }}</li>
				<li class="treeview">
				  <a href="#">
				...
				<li class="header">{{ trans('teacher.teacher') }} </li>
				<li class="treeview">
				  <a href="#">
					<i class="si-people si"><span class="path1"></span><span class="path2"></span></i>
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						  ...
						  @if ($properties['native'] == "العربية")
						    <li><a hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>{{ $properties['native'] }}</a></li>
						  @endif
