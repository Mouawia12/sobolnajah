                        ...
                        <div class="col-lg-6 col-12 position-relative">
                            <div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="../images/front-end-img/avatar/1.jpg" alt="...">
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="../images/front-end-img/avatar/2.jpg" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="../images/front-end-img/avatar/3.jpg" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-0" href="#">
                                  <img class="w-80 rounded ms-0" src="../images/front-end-img/avatar/4.jpg" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
                ...
                <div class="blog-post">
                    <div class="entry-image clearfix">
                        <ul class="grid-post list-unstyled">
                            <li>
                                <img class="img-fluid" src="{{ asset('images/front-end-img/courses/5f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('images/front-end-img/courses/6f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('images/front-end-img/courses/7f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('images/front-end-img/courses/8f.jpg')}}" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="blog-detail">
